        ...
        <section class="wrapper">            
            ...
            <div class="row">
                <div class="col-lg-12 page_links">
                    <h3 class="page-header"><i class="fa fa-building"></i><a href="bravo_delivery_success.php"> Bravo Delivered Order</a></h3>
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-truck"></i><a href="bravo_delivery_success.php" style="color: blue;">Delivered</a></li>
...
<?php
        ...
        $query = "SELECT d.delivery_id, d.delivery_receipt_no, d.item_no, d.quantity, d.gate_pass, d.po_no_delivery, DATE_FORMAT(d.date_delivery,'%m/%d/%y') as date_delivery1 , d.office, d.remarks, d.fk_po_id, s.site_name, s.site_address, GROUP_CONCAT(DISTINCT p.site_contact_name ORDER BY p.site_contact_name ASC SEPARATOR ', ') as site_contact_name, c.client_name
