        ...
        <section class="wrapper">            
            ...
            <div class="row">
                <div class="col-lg-12 page_links">
                    <h3 class="page-header"><i class="fa fa-building"></i> <a href="delta_delivery_success.php">Delta Delivered Order</a></h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-building"></i>Delta</li>
                        <li><i class="icon_document"></i><a href="delta_delivery_order.php">Delivery Order</a></li>
                        <li><i class="fa fa-info-circle"></i><a href="delta_delivery_issue.php">No DR. No. <span class='badge'><?php echo countPendingPo($db, 'delta'); ?></span></a></li>
                        <li><i class="fa fa-truck"></i><a href="delta_delivery_success.php" style="color: blue;">Delivered</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <form action="delta_delivery_success.php" method="get" class="form-inline">
...
<?php
        ...
        $sql = "SELECT * FROM delivery d, site s ".$string." AND d.site_id = s.site_id ".$string_date." ".$string_ext."  AND remarks = 'Delivered'
        ...
        $adjacents = 3;
        $targetpage = "delta_delivery_success.php"; //your file name
        $page = $_GET['page'];
...
?>  
                            <tr>
                                ...
                                <td class="col-md-1" style="cursor: pointer;">
                                    <div class="tooltips" data-original-title="Click for more details about P.O. No. <?php echo $row['po_no_delivery'] ?>" data-placement="top" onclick="window.location='delta_po_details.php?fk_po_id=<?php echo $row['fk_po_id']; ?>&po_no_delivery=<?php echo $row['po_no_delivery']; ?>'">
...
<?php
        ...
        if($lastpage > 1){ 
            $pagination .= "<div class='pagination1'> <ul class='pagination'>";
            if ($page > $counter+1) {
                $pagination.= "<li class='page-item'><a class='page-link' href=\"$targetpage?page=$prev&radioOffice=$search_plant&start_date=$start_date&end_date=$end_date&search=$search_word&view_count=$limit\">Previous</a></li>"; 
            }
            ...
            if ($lastpage < 7 + ($adjacents * 2)) { 
                for ($counter = 1; $counter <= $lastpage; $counter++){
                    ...
                    $pagination.= "<li class='page-item'><a class='page-link' href=\"$targetpage?page=$counter&radioOffice=$search_plant&start_date=$start_date&end_date=$end_date&search=$search_word&view_count=$limit\">$counter</a></li>"; 
                }
            }
            elseif($lastpage > 5 + ($adjacents * 2)){ //enough pages to hide some
                //close to beginning; only hide later pages
                if($page < 1 + ($adjacents * 2)) {
                    ...
                    $pagination.= "<li class='page-item'><a class='page-link' href='#'>...</a></li>";
                    $pagination.= "<li class='page-item'><a class='page-link' href=\"$targetpage?page=$lpm1&radioOffice=$search_plant&start_date=$start_date&end_date=$end_date&search=$search_word&view_count=$limit\">$lpm1</a></li>";
                    $pagination.= "<li class='page-item'><a class='page-link' href=\"$targetpage?page=$lastpage&radioOffice=$search_plant&start_date=$start_date&end_date=$end_date&search=$search_word&view_count=$limit\">$lastpage</a></li>"; 
                }
                //in middle; hide some front and some back
                elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2)){
                    $pagination.= "<li class='page-item'><a class='page-link' href=\"$targetpage?page=1&radioOffice=$search_plant&start_date=$start_date&end_date=$end_date&search=$search_word&view_count=$limit\">1</a></li>";
                    $pagination.= "<li class='page-item'><a class='page-link' href=\"$targetpage?page=2&radioOffice=$search_plant&start_date=$start_date&end_date=$end_date&search=$search_word&view_count=$limit\">2</a></li>";
                    $pagination.= "<li class='page-item'><a class='page-link' href='#'>...</a></li>";
                    for ($counter = $page - $adjacents; $counter <= $page + $adjacents; $counter++){
                        if ($counter == $page)
                        $pagination.= "<li class='page-item active'><a class='page-link' href='#'>$counter</a></li>";
            ...
            //next button
            if ($page < $counter - 1) 
                $pagination.= "<li class='page-item'><a class='page-link' href=\"$targetpage?page=$next&radioOffice=$search_plant&start_date=$start_date&end_date=$end_date&search=$search_word&view_count=$limit\">Next</a></li>";
            else
                $pagination.= "";
            $pagination.= "</ul></div>\n"; 
        }
