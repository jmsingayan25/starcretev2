            ...
            <div class="row">
                <div class="col-lg-12 page_links">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="icon_document"></i><a href="bravo_delivery_order.php">Delivery Order <span class="badge"><?php echo getDeliveryCountOnDeliveryOffice($db, $search_plant); ?></span></a></li>
