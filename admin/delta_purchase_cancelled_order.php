...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            url: 'delta_purchase_cancelled_order.php',
            method: get,
            data:{
                var1 : val1
            },
            ...
            <section class="wrapper">            
                ...
                <div class="row">
                    <div class="col-lg-12 page_links">
                        <h3 class="page-header"><a href="delta_purchase_cancelled_order.php"><i class="fa fa-building"></i> Delta Cancelled Order</a></h3>
                        <ol class="breadcrumb">
                        <li><i class="fa fa-building"></i>Delta</a></li>
                        <li><i class="icon_document"></i><a href="delta_purchase_order.php">Purchase Order</a></li>                            
                        <li><i class="icon_document"></i><a href="delta_purchase_cancelled_order.php" style="color: blue;">Cancelled Order</a></li>                          
                    </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
                            <form action="delta_purchase_cancelled_order.php" method="get" class="form-inline">
                                <header class="panel-heading">
                                    <div class="row" style="margin-bottom: 5px;">
                                        ...
                                        <!-- <div class="pull-right" style="margin-right: 10px; margin-top: 39px;">
                                            <a href="bravo_purchase_order_form.php" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add Purchase Order</a>
                                        </div> -->
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
...
<?php
        ...
        $adjacents = 3;
        $targetpage = "delta_purchase_cancelled_order.php"; //your file name
        $page = $_GET['page'];
        ...
        // $query = "SELECT p.purchase_id, p.purchase_order_no, c.site_name, p.item_no, CONCAT(FORMAT(p.cancelled,0), ' ', l.unit) as cancelled, delivered, backload, balance, c.address, contact_person, contact_no, DATE_FORMAT(date_cancelled,'%m/%d/%y') as date_cancelled, DATE_FORMAT(date_cancelled,'%m/%d/%y') as date_cancelled1, office, remarks
...
?>
                                ...
                                <td class="col-md-1"><strong><?php echo $row['date_cancelled']; ?></strong></td>
