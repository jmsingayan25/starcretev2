...
<!-- container section start -->
    ...
    <section id="main-content">
        <section class="wrapper">            
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i> Delta Delivery Order</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-building"></i>Delta</li>
                        <li><i class="icon_document_alt"></i>Delivery Order</li>
                    ...
                    <table class="table table-striped table-bordered">
                        <thead>
                            ...
                            <tr class="filters">
                                ...
                                <th class="col-md-1"><input type="text" class="form-control" placeholder="Site Name" disabled></th>
...
?>
                            <tr>
                                ...
                                <td class='col-md-1'><strong><?php echo $row['site_name']; ?></strong></td>
