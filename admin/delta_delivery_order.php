        ...
        <section class="wrapper">            
            ...
            <div class="row">
                <div class="col-lg-12 page_links">
                    <h3 class="page-header"><i class="fa fa-building"></i> <a href="delta_delivery_order.php">Delta Delivery Order</a></h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-building"></i>Delta</li>
                        <li><i class="icon_document"></i><a href="delta_delivery_order.php" style="color: blue;"> Delivery Order</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <form action="delta_delivery_order.php" method="get" class="form-inline">
...
<?php
    ...
    $adjacents = 3;
    $targetpage = "delta_delivery_order.php"; //your file name
    $page = $_GET['page'];
...
<?php
    ...
    // $query = "SELECT delivery_id, delivery_receipt_no, po_no_delivery, fk_po_id, item_no, quantity, c.client_name, c.site_name, c.address, contact, contact_no, gate_pass, office, remarks, FORMAT(quantity,0) as quantity, DATE_FORMAT(date_delivery,'%m/%d/%y') as date_delivery 
    //          FROM delivery d, client c ".$string." ".$string_date."
    //          AND d.client_id = c.client_id
    //          AND remarks = 'On Delivery' 
    //          ORDER BY delivery_id DESC
