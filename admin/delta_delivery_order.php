            ...
            <div class="row">
                <div class="col-lg-12 page_links">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="icon_document"></i><a href="delta_delivery_order.php" style="color: blue;">Delivery Order <span class="badge"><?php echo getDeliveryCountOnDeliveryOffice($db, 'delta'); ?></span></a></li>
