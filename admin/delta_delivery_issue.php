    ...
    <section id="container" class="">
        ...
        <section id="main-content">
            <section class="wrapper">            
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><a href="delta_delivery_issue.php"><i class="fa fa-laptop"></i> Delta Delivery Order</a></h3>
                        <ol class="breadcrumb">
                            <li><i class="fa fa-building"></i>Delta</li>
                            <li><a href="delta_delivery_order.php"><i class="icon_document_alt"></i>Delivery Order</a></li>
                            <li><i class="fa fa-info-circle"></i>No DR. No. <span class='badge'><?php echo countPendingPo($db, 'delta'); ?></span></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
                            <form action="delta_delivery_issue.php" method="get" class="form-inline">
...
<?php
    ...
    $adjacents = 3;
    $targetpage = "delta_delivery_issue.php"; //your file name
    $page = $_GET['page'];
    ...
    $query = "SELECT p.purchase_id, p.item_no, p.purchase_order_no, s.site_name, s.site_address, p.item_no, p.quantity, p.balance, l.unit, GROUP_CONCAT(DISTINCT c.site_contact_name,' ') as site_contact_name, DATE_FORMAT(p.date_purchase,'%m/%d/%y') as date_purchase, p.office, p.remarks
...
?>
                            <tr>
                                ...
                                <td class="col-md-1" style="cursor: pointer;">
                                    <div class="tooltips" data-original-title="Click for more details about P.O. No. <?php echo $row['purchase_order_no'] ?>" data-placement="top" onclick="window.location='delivery_po_order_no_details.php?fk_no=<?php echo $row['purchase_id']; ?>&po_no_delivery=<?php echo $row['purchase_order_no']; ?>&office=<?php echo $row['office']; ?>'">
