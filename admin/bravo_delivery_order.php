...
<!-- container section start -->
    ...
    <section id="main-content">
        <section class="wrapper">            
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><a href="bravo_delivery_order.php"><i class="fa fa-laptop"></i> Bravo Delivery Order</a></h3>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <form action="bravo_delivery_order.php" method="get" class="form-inline">
...
<?php
    ...
    $adjacents = 3;
    $targetpage = "bravo_delivery_order.php"; //your file name
    $page = $_GET['page'];
