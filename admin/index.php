...
?>
                                            ...
                                            <input type="text" class="form-control" placeholder="Type of Transaction" disabled>
                                        </th>
...
?>
                        <tr>
                            <td class="col-md-1"><?php echo $row['transaction_type']; ?></td>
                            <td class="col-md-5" style='text-align: justify;'><?php echo $row['detail']; ?></td>
                            <td class="col-md-1"><?php echo $row['history_date1']; ?></td>
                        </tr>
<?php
      }
    }else{
