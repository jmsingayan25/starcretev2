        ...
        <section class="wrapper">            
            ...
            <div class="row">
                <div class="col-lg-12 page_links">
                    <h3 class="page-header"><a href="delta_delivery_backload.php"><i class="fa fa-building"></i> Delta Backloaded Order</a></h3>
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-reply"></i><a href="delta_delivery_backload.php" style="color: blue;">Backload</a></li>                             
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <form action="delta_delivery_backload.php" method="get" class="form-inline">
...
<?php
    ...
    $sql = "SELECT * FROM delivery d, site s, site_contact_person p ".$string." 
    ...
    $adjacents = 3;
    $targetpage = "delta_delivery_backload.php"; //your file name
    $page = $_GET['page'];
    ...
    $query = "SELECT d.delivery_id, d.delivery_receipt_no, d.item_no, d.quantity, d.gate_pass, d.po_no_delivery, DATE_FORMAT(d.date_delivery,'%m/%d/%y') as date_delivery , d.office, d.remarks, d.fk_po_id, s.site_name, s.site_address, p.site_contact_name, c.client_name, GROUP_CONCAT(sc.site_contact_no SEPARATOR ', ') as site_contact_no, d.psi
