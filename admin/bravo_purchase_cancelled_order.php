            ...
            <section class="wrapper">            
                ...
                <div class="row">
                    <div class="col-lg-12 page_links">
                        <h3 class="page-header"><i class="fa fa-building"></i> <a href="bravo_purchase_cancelled_order.php">Bravo Cancelled Order</a></h3>
                        <ol class="breadcrumb">
                            <li><i class="fa fa-building"></i>Bravo</a></li>
                            <li><i class="icon_document"></i><a href="bravo_purchase_order.php">Purchase Order</a></li>
                            <li><i class="icon_document"></i><a href="bravo_purchase_cancelled_order.php" style="color: blue;">Cancelled Order</a></li>   
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
                            <form action="bravo_purchase_cancelled_order.php" method="get" class="form-inline">
...
<?php
        ...
        $adjacents = 3;
        $targetpage = "bravo_purchase_cancelled_order.php"; //your file name
        $page = $_GET['page'];
