	...
	<!--                 <li class="sub-menu">                       
	    ...
	    <section id="main-content">
	        <section class="wrapper">            
	            ...
	            <div class="row">
	                <div class="col-lg-12">
	                    <h3 class="page-header"><i class="fa fa-laptop"></i> No DR No.</h3>
	                    <ol class="breadcrumb">
	                        <li><i class="fa fa-home"></i><a href="plant_delivery_order.php">Delivery Order</a></li>
	                        <li><i class="fa fa-laptop"></i>No DR. No.</li>						  	
	                    </ol>
	                </div>
	            </div>
	            ...
	            <div class="row">
	            	<div class="col-md-12">
	                    <section class="panel">
	                        <form action="plant_delivery_issue.php" method="post" class="form-inline">
