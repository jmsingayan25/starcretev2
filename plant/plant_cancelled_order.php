	...
	<!--                 <li class="sub-menu">                       
	    ...
	    <section id="main-content">
	        <section class="wrapper">            
	            ...
	            <div class="row">
	                <div class="col-lg-12">
	                    <h3 class="page-header"><i class="fa fa-laptop"></i> Cancelled Order</h3>
	                    <ol class="breadcrumb">
	                        <li><i class="fa fa-home"></i><a href="plant_purchase_order.php">Purchase Order</a></li>
	                        <li><i class="fa fa-laptop"></i>Cancelled Order</li>						  	
	                    </ol>
	                </div>
	            </div>
	            ...
	            <div class="row">
	            	<div class="col-md-12">
	                    <section class="panel">
	                        <form action="plant_cancelled_order.php" method="post" class="form-inline">
...
<?php
        ...
        $query = "SELECT o.purchase_id, o.purchase_order_no, o.item_no, o.quantity, o.delivered, o.backload, o.balance, o.cancelled, o.office, o.remarks, l.unit, s.site_name, s.site_address, p.site_contact_name, DATE_FORMAT(o.date_purchase,'%m/%d/%y') as date_purchase, DATE_FORMAT(o.date_cancelled,'%m/%d/%y') as date_cancelled1 
...
?>
                            <tr>
                                ...
                                <td style="background: #e60000; color: white;">
